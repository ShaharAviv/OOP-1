...
This program is a Calculator that can run diffrent opertions of functions
...
Function.h:
an abstract class for the functions.
...
Ln.cpp & Ln.h:
function to calculate basic log with netrual("e") base. (^ Log)
...
Vector of smart pointers (Shared Pointer) to Function 

================================================================================================
Remarkable Algorithms:
--------------------------------
Composite:
Using clone() and setVar() to change samrtly only  inner paer of function
